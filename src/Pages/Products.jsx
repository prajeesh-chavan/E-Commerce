...
function Products() {
  ...
  const [priceRange, setPriceRange] = useState([500, 10000]); // Default price range
  ...
  return (
    ...
    {/* bar */}
      <div className="sticky top-0 z-10 bg-white shadow-md">
        <div className="h-16 flex items-center p-5 lg:px-14 justify-between">
          ...
          <div className="relative text-gray-600">
            <input
              className="border-2 border-gray-300 bg-white h-10 w-32 sm:w-64 lg:w-96 md:px-4 pr-10 rounded-lg text-md focus:outline-slate-400"
              type="text"
              name="search"
              placeholder="Search"
            />
      ...
      {isFilterModalVisible && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-70 flex items-center justify-center z-30">
          <div className="relative bg-white flex rounded-lg shadow-lg w-1/2 h-2/3">
            {/* Side Menu */}
